    ...
    <section className="py-20 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
          Converto estrutura seu setor comercial dentro do WhatsApp: etapas claras, alertas de follow-up e histórico guardado.
          Sem implantação longa, sem custo alto — só controle diário das negociações.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto text-sm opacity-90">
          ...
          <div>Mensalidade acessível para empresas locais</div>
        </div>
      </div>
    </section>
  )
