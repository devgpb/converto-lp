...
import { PricingPlansCtaButton } from "@/components/pricing-plans-cta-button"
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-16">
        ...
        <h2 className="text-4xl gradient-text md:text-5xl font-bold text-foreground mb-4 text-balance">
